...
# json_response = acquire_json_response
# get_all_courses(json_response)
# get_course_by_id(json_response, 'cs101')
# get_course_by_title(json_response, 'Intro to Java Programming')
# get_course_by_level(json_response, '')
# get_course_by_level(json_response, 'beginner')
# get_course_by_tracks(json_response, 'Data Science')
